const user=require("../../../model/feedback/EStudies")
const { success, error } = require("../../../utils/wrapper");
const EStudiesFeedback = async (req,res)=>{
...
const getEStudies = async (req, res) => {
    try {
...
module.exports={EStudiesFeedback,getEStudies}